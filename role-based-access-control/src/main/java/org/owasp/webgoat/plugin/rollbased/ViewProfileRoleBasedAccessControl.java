 ...
 */
public class ViewProfileRoleBasedAccessControl extends DefaultLessonAction
{

    public ViewProfileRoleBasedAccessControl(GoatHillsFinancial lesson, String lessonName, String actionName)
    {

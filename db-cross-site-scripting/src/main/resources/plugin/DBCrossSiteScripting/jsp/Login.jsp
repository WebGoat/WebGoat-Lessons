<%@ page contentType="text/html; charset=ISO-8859-1" language="java" 
	import="org.owasp.webgoat.plugin.GoatHillsFinancial.EmployeeStub, org.owasp.webgoat.plugin.db_cross_site.DBCrossSiteScripting, org.owasp.webgoat.session.WebSession"
	errorPage="" %>
